...
public class MockPlugin : Plugin
{
    ...
    public MockPlugin(IDalamudPluginInterface pluginInterface, ILogger<MockPlugin> logger, IPluginLog pluginLog,
        IFramework framework, ICommandManager commandManager, IDataManager dataManager,
        ITextureProvider textureProvider, IChatGui chatGui, IDtrBar dtrBar)
