namespace MockSequencer.Services;

using System.Threading;
using System.Threading.Tasks;
using DalaMock.Host.Mediator;
using MockSequencer.Mediator;
using MockSequencer.Windows;
...
public class CommandService(ICommandManager commandManager, MediatorService mediatorService) : IHostedService
{
    ...
    private readonly string[] commandName = { "/mocksequencer", "/mocksequenceralias" };
